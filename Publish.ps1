...
.PARAMETER CleanBuildDirectory
    Default: $True

    If True the build directory will be deleted before building the mod. Disable this if additional files are put in the build directory externally.
...
param (
    ...
    ## => User Config <= ## 
    $ProjectPath = "UnrealEssentials.csproj",
    ...
    $NuGetPackageId = "UnrealEssentials",
...
$CleanBuildDirectory = [bool]::Parse($CleanBuildDirectory)
